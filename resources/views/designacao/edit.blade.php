...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ url('/designacoes') }}">Listagem designacao</a>
    </li>

    <li class="breadcrumb-item">
        <a href="{{ url('/designacoes' . '/' . $designaco->id . '/edit') }}">Editar designacao</a>
    </li>
@endsection
...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Editar designação {{ $designaco->id }}</div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/designacoes' . '/' . $designaco->id) }}" accept-charset="UTF-8"
                            ...
                            @include('designacao.form', ['formMode' => 'edit'])
