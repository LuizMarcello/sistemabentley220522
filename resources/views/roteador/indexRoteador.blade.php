                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('roteadores.create') }}" class="btn btn-success">Novo
                                Roteador</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @forelse ($registros as $registro)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('roteadores.show', $registro) }}"
                                                class="btn btn-primary btn-sm">Detalhees</a>
                                            <a href="{{ route('roteadores.edit', $registro) }}"
