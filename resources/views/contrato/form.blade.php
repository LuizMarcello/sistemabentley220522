        ...
        <div class="col">
            <div class="row">
                <div class="form-check col-sm-1">
                    <input class="form-check-input" type="radio" name="cortesia" id="cortesia1" value="sim"
                        checked>
                ...
                <br>
                <div class="form-check col-sm-1">
                    <input class="form-check-input" type="radio" name="cortesia" id="cortesia2" value="Não">
...
<div class="container">
    ...
    <div class="div_desconto form-group {{ $errors->has('desconto') ? 'has-error' : '' }}">
        ...
        <div class="col">
            <div class="row">
                <input type="number" name="desconto" class="form-control col-form-label col-sm-8" id="desconto"
                    oninput="Num()" value="{{ old('contrato', @$contrato->desconto) }}">&nbsp;
    ...
    <div class="div_msg_pend_automatica form-group {{ $errors->has('msg_pend_automatica') ? 'has-error' : '' }}">
        ...
        <select name="msg_pend_automatica" class="form-control col-form-label col-sm-8" id="msg_pend_automatica">
            @foreach (json_decode('{" padrão":"Padrâo","sim":"Sim","nao":"Não"}', true) as $optionKey => $optionValue)
    ...
    <div class="div_dias_para_pendencia form-group {{ $errors->has('dias_para_pendencia') ? 'has-error' : '' }}">
        <div class="col">
            ...
            <div class="row">
                <input class="form-control col-form-label col-sm-8" type="number" name="dias_para_pendencia"
                    id="dias_para_pendencia" oninput="Num()"
                    value="{{ old('dias_para_pendencia', @$contrato->dias_para_pendencia) }}">&nbsp;
                {!! $errors->first('dias_para_pendencia', '<p class="help-block">:message</p>') !!}
            </div>
        </div>
        <div>
    ...
    <div class="div_acrescimo form-group {{ $errors->has('acrescimo') ? 'has-error' : '' }}" style="align-self;">
        <label for="acrescimo" class="control-label">{{ 'Acréscimo R$' }}</label>
        <div class="col">
            <div class="row">
                <input type="number" name="acrescimo" class="form-control col-form-label col-sm-7" id="acrescimo"
                    oninput="Num()" value="{{ old('acrescimo', @$contrato->acrescimo) }}">
                &nbsp;
                {!! $errors->first('acrescimo', '<p class="help-block">:message</p>') !!}
            </div>
        </div>
    </div>
    ...
    <div class="div_dias_para_bloqueio form-group {{ $errors->has('dias_para_bloqueio') ? 'has-error' : '' }}">
        <div class="col">
            ...
            <div class="row">
                <input class="form-control col-form-label col-sm-8" type="number" name="dias_para_bloqueio"
                    id="dias_para_bloqueio" oninput="Num()"
                    value="{{ old('dias_para_bloqueio', @$contrato->dias_para_bloqueio) }}">&nbsp;
                {!! $errors->first('dias_para_bloqueio', '<p class="help-block">:message</p>') !!}
            </div>
        </div>
        <div>
            <h6>Em branco Config. padrão</h6>
    ...
    <div class="div_dia_de_pagamento form-group {{ $errors->has('dia_de_pagamento') ? 'has-error' : '' }}">
        <div class="col">
            ...
            <div class="row">
                <input class="form-control col-form-label col-sm-11" type="date" name="dia_de_pagamento"
                    id="dia_de_pagamento" oninput="Num()"
                    value="{{ old('dia_de_pagamento', @$contrato->dia_de_pagamento) }}"> &nbsp;
                {!! $errors->first('dia_de_pagamento', '<p class="help-block">:message</p>') !!}
            </div>
        </div>
    </div>
    ...
    <div class="div_modelo_de_contrato form-group {{ $errors->has('modelo_de_contrato ') ? 'has-error' : '' }}">
        ...
        <select name="modelo_de_contrato" class="form-control col-form-label col-sm-12" id="modelo_de_contrato"
            ...
            @foreach (json_decode('{"buscarmodelo1":"Buscar modelo 1","buscarmodelo2":"Buscar Modelo 2"}', true) as $optionKey => $optionValue)
                <option value="{{ $optionKey }}"
