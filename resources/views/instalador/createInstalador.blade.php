...
@section('title')
    ...
    <div class="card-tools">
        <a href="{{ route('instaladores.index') }}" class="btn btn-success">Voltar</a>
    </div>
@endsection

@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ route('instaladores.index') }}">Listagem de Instaladores</a>
    </li>

    <li class="breadcrumb-item">
        <a href="{{ route('instaladores.create') }}">Novo Instalador</a>
    </li>
@endsection
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    {{-- O corpo --}}
                    <div class="card-body">
                        <form action="{{ route('instaladores.store') }}" method="POST">
