...
@section('title')
    <h3>Editando o instalador: {{ $instalador->nome }}</h3>
...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ route('instaladores.index', $instalador) }}">Listagem de Instaladores</a>
    </li>

    <li class="breadcrumb-item">
        <a href="{{ route('instaladores.edit', $instalador) }}">Editar</a>
    </li>
@endsection
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    {{-- O corpo --}}
                    <div class="card-body">
                        <form action="{{ route('instaladores.update', $instalador) }}" method="POST">
                            {{-- {{ csrf_field() }} --}}
                            @method('PUT')
                            {{-- ou assim --}}
