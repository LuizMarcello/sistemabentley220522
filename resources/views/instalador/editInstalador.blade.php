...
@section('title')
    <h3>Editando o instalador: {{ $instaladore->nome }}</h3>
...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ route('instaladores.index', $instaladore) }}">Listagem de Instaladores</a>
    </li>

    <li class="breadcrumb-item">
        <a href="{{ route('instaladores.edit', $instaladore) }}">Editar</a>
    </li>
@endsection
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    {{-- O corpo --}}
                    <div class="card-body">
                        <form action="{{ route('instaladores.update', $instaladore) }}" method="POST">
                            {{-- {{ csrf_field() }} --}}
                            @method('PUT')
                            {{-- ou assim --}}
                            {{-- <input type="hidden" name="_method" value="put"> --}}
                            @include('instalador._formInstalador')
                        </form>
                    </div>
