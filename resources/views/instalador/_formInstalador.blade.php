...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('ie_rg', @$instalador->ie_rg) }}" type="text" id="ie_rg" name="ie_rg"
...
<div id="cliente">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input value="{{ old('email', @$instalador->email) }}" type="email" id="email" name="email"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input value="{{ old('cep', @$instalador->cep) }}" type="text" id="cep" name="cep"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input value="{{ old('bairro', @$instalador->bairro) }}" type="text" id="bairro1" name="bairro"
    ...
    {{-- <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input value="{{ old('situacao', @$instalador->situacao) }}" type="text" id="situacao"
