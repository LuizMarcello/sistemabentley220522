...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('observacao', @$ilnb->notafiscal) }}" type="text" id="notafiscal" name="notafiscal"
...
<div class="form-group row{{ $errors->has('datanota') ? 'has-error' : '' }}">
    ...
    <input style="margin-left: 1.3%" class="form-control col-form-label col-sm-3" rows="5" name="datanota"
        type="date" id="datanota" required value="{{ old('datanota', @$ilnb->datanota) }}">
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('banda', @$ilnb->banda) }}" type="text" id="banda" name="banda"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('marca', @$ilnb->marca) }}" type="text" id="marca" name="marca"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('modelo', @$ilnb->modelo) }}" type="text" id="modelo" name="modelo"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('serial', @$ilnb->serial) }}" type="text" id="serial" name="serial"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('observacao', @$ilnb->observacao) }}" type="text" id="observacao" name="observacao"
...
<div class="form-group row">
    ...
    <div class="col-sm-3">
        <select class="form-select" name="situacao" id="situacao">
            ...
            <option value="ativo" {{ <?php echo selected('ativo', @$ilnb->situacao); ?> }}>Ativo</option>
            <option value="em espera" {{ <?php echo selected('em espera', @$ilnb->situacao); ?> }}>Em espera</option>
            <option value="suspenso" {{ <?php echo selected('suspenso', @$ilnb->situacao); ?> }}>Suspenso</option>
            <option value="inativo" {{ <?php echo selected('inativo', @$ilnb->situacao); ?> }}>Inativo</option>
        </select>
    </div>
</div>
